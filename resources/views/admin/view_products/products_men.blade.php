                ...
                <div class="card-body">
                    <table class="center">
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-danger" onclick="return confirm('Siz haqiqatdan ham manashu mahsulotni o\'chirmoqchimisiz?')" wire:click.prevent="products_delete({{ $product->id }})">Delete</a></td>
