                ...
                <div class="card-body">
                    <table class="center">
                        ...
                        <tr>
                            ...
                            @endforeach
                            <td><a class="btn btn-danger" onclick="return confirm('Siz haqiqatdan ham manashu mahsulotni o\'chirmoqchimisiz?')" href="{{url('special_delete,$product->id')}}">Delete</a></td>
